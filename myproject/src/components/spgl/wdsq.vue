<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>我的索赔</el-breadcrumb-item>
    </el-breadcrumb>
    <!-- 搜索选项 卡片视图区 -->
    <el-card>
      ...
      >
        ...
        <span slot="footer" class="dialog-footer">
          ...
          <el-button type="primary" @click="doAudit(true)"
                     v-show="editForm.claimsStatus === '待审核'">审核通过</el-button>
          <el-button type="primary" @click="doAudit(false)"
                     v-show="editForm.claimsStatus === '待审核'">审核不通过</el-button>
          <el-button type="primary" @click="lipeiDialogVisible = true"
                     v-show="editForm.claimsStatus === '待审核'">进行理赔</el-button>
        </span>
      </el-dialog>
      <el-dialog
          title="理赔"
